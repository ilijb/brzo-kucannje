...
INSERT INTO `tekst` VALUES (1,'Roman je dugačak pripovedni tekst napisan u prozi|| Prema podeli na književne rodove, roman spada u epiku|| tačnije ubraja se kao književna vrsta u epskoj poeziji u prozi|| Formalne osobenosti romana je teško precizno definisati|| ali je u načelu u pitanju složena, obimnija narativna forma|| kako u pogledu količine teksta, tako i u pogledu opsega zbivanja koje opisuje','Tekst 1',1);

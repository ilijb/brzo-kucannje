...
exports.DefaultkorisnikAdapterOptions = void 0;
const BaseService_1 = require("../../common/BaseService");
const korisnikModel_model_1 = require("./korisnikModel.model");
const DefaultkorisnikAdapterOptions = {
    test: false,
};
exports.DefaultkorisnikAdapterOptions = DefaultkorisnikAdapterOptions;
class korisnikService extends BaseService_1.default {
    tableName() {
        return "korisnik";
    }
    adaptToModel(data, options = DefaultkorisnikAdapterOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const korisnik = new korisnikModel_model_1.default();
...
exports.default = korisnikService;
//# sourceMappingURL=korisniKService.service.js.map